		...
		case SDL_JOYHATMOTION:
			for (int i = 0; i < SDL_NumJoysticks(); i++)
				if (i == event.jbutton.which)
					...
					{
					case SDL_HAT_UP:		//SDL_Log("Play %d Hat ¡è", i + 1);
						break;
					case SDL_HAT_LEFTUP:	//SDL_Log("Play %d Hat ¢Ø", i + 1);
						break;
					case SDL_HAT_LEFT:		//SDL_Log("Play %d Hat ¡ç", i + 1);
						break;
					case SDL_HAT_LEFTDOWN:	//SDL_Log("Play %d Hat ¢×", i + 1);
						break;
					case SDL_HAT_DOWN:		//SDL_Log("Play %d Hat ¡é", i + 1);
						break;
					case SDL_HAT_RIGHTDOWN:	//SDL_Log("Play %d Hat ¢Ù", i + 1);
						break;
					case SDL_HAT_RIGHT:		//SDL_Log("Play %d Hat ¡æ", i + 1);
						break;
					case SDL_HAT_RIGHTUP:	//SDL_Log("Play %d Hat ¢Ö", i + 1);
						break;
					}
			break;
		//Extention Device
